const Cognito = require("./amazon-cognito-identity.min.js");
import * as AWS from "aws-sdk";
import * as fs from "fs";

const options = new AWS.Config({
    region: "us-east-1"
});
...
function authorize() {
    ...
    var poolData = {
        UserPoolId : 'us-east-1_99IKinAx7', // Your user pool id here
    ...
    cognitoUser.authenticateUser(authenticationDetails, {
        onSuccess: function (result) {
            ...
            AWS.config.credentials = new AWS.CognitoIdentityCredentials({
                IdentityPoolId : 'us-east-1:5133c8e3-ced1-45d5-9a79-224f967d1f70', // your identity pool id here
                Logins : {
